...
/**
 * An {@link InfoContributor} that exposes the actual ranges used by dependencies defined in the
 * project that have an explicit version (i.e. not relying on a bom).
 *

...
import com.intellecteu.catalyst.metadata.MetadataElement;
...
public class CommandLineHelpGenerator {
  ...
  /**
   * Generate the capabilities of the service as a generic plain text document. Used when no
   * particular agent was detected.
   */
  ...
  private static class TableGenerator {
    ...
    /**
     * Generate a table description for the specified {@code content}. <p> The {@code content} is a
     * two-dimensional array holding the rows of the table. The first entry holds the header of the
     * table.
     */

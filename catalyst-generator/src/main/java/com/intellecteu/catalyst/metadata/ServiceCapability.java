...
/**
 * Defines a capability of the initializr service. Each capability is defined by a id and a {@link
...
public abstract class ServiceCapability<T> implements Cloneable {
  ...
  /**
   * Return the "content" of this capability. The structure of the content vastly depends on the
   * {@link ServiceCapability type} of the capability.
   */
  ...
  /**
   * Merge this capability with the specified argument. The service capabilities should match (i.e
   * have the same {@code id} and {@code type}). Sub-classes may merge additional content.
   */

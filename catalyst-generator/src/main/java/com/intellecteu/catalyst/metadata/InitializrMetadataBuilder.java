...
public class InitializrMetadataBuilder {
  ...
  /**
   * Create a builder instance from the specified {@link InitializrProperties}. Initialize the
  ...
  /**
   * Add a {@link InitializrMetadataCustomizer}. customizers are invoked in their order of
   * addition.
   *
   * @see InitializrMetadataCustomizer
   */

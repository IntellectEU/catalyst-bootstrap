...
public class DependencyGroup {
  ...
  /**
   * Return the default version range to apply to all dependencies of this group unless specified
   * otherwise.
   */
  ...
  /**
   * Return the default bom to associate to all dependencies of this group unless specified
   * otherwise.
   */
  ...
  /**
   * Return the default repository to associate to all dependencies of this group unless specified
   * otherwise.
   */

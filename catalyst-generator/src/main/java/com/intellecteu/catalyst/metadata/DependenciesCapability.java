...
/**
 * A {@link ServiceCapability} listing the available dependencies defined as a {@link
...
public class DependenciesCapability extends ServiceCapability<List<DependencyGroup>> {
  ...
  /**
   * Return the {@link Dependency} with the specified id or {@code null} if no such dependency
   * exists.
   */

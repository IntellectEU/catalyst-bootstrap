...
/**
 * Define a {@link Version} range. A square bracket "[" or "]" denotes an inclusive end of the range
 * and a round bracket "(" or ")" denotes an exclusive end of the range. A range can also be
 * unbounded by defining a a single {@link Version}. The examples below make this clear.
 *
 * <ul> <li>"[1.2.0.RELEASE,1.3.0.RELEASE)" version 1.2.0 and any version after this, up to, but not
 * including, version 1.3.0.</li> <li>"(2.0.0.RELEASE,3.2.0.RELEASE]" any version after 2.0.0 up to
 * and including version 3.2.0.</li> <li>"1.4.5.RELEASE", version 1.4.5 and all later versions.</li>
 * </ul>
 *
...
public class VersionRange {
  ...
  /**
   * Specify if the {@link Version} matches this range. Returns {@code true} if the version is
   * contained within this range, {@code false} otherwise.
   */

...
/**
 * Represents a valid property for a version. A property must be lower case and can define a dot or
 * an hyphen to separate words. For instance, "foo-acme.version", "foo.acme.version" or
 * "foo-acme-version" are valid properties.
 *

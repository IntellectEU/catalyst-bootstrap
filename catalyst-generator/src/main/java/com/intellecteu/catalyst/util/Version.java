 ...
 * MAJOR.MINOR.PATCH.QUALIFIER} where the qualifier can have an extra version. <p> For example:
 * {@code 1.2.0.RC1} is the first release candidate of 1.2.0 and {@code 1.5.0.M4} is the fourth
 * milestone of 1.5.0. The special {@code RELEASE} qualifier indicates a final release (a.k.a. GA)
 * <p> The main purpose of parsing a version is to compare it with another version, see {@link
 * Comparable}.
 *

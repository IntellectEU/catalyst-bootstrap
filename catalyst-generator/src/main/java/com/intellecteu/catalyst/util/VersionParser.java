...
import com.intellecteu.catalyst.util.Version.Qualifier;
...
/**
 * Parser for {@link Version} and {@link VersionRange} that allows to resolve the minor and patch
 * value against a configurable list of "latest versions". <p> For example a parser that is
 * configured with {@code 1.3.7.RELEASE} and {@code 1.4.2.RELEASE} as latest versions can parse
 * {@code 1.3.x.RELEASE} to {@code 1.3.7.RELEASE}. Note that the qualifier is important here: {@code
 * 1.3.8.BUILD-SNAPSHOT} would be parsed as {@code 1.3.999.BUILD-SNAPSHOT} as the parser doesn't
 * know the latest {@code BUILD-SNAPSHOT} in the {@code 1.3.x} release line.
 *
...
public class VersionParser {
  ...
  /**
   * Parse the string representation of a {@link Version}. Throws an {@link InvalidVersionException}
  ...
  /**
   * Parse safely the specified string representation of a {@link Version}. <p> Return {@code null}
   * if the text represents an invalid version.
   *
   * @param text the version text
   * @return a Version instance for the specified version text
  ...
  /**
   * Parse the string representation of a {@link VersionRange}. Throws an {@link
   * InvalidVersionException} if the range could not be parsed.
   *

...
public class ProjectAssert {
  ...
  /**
   * Validate that the project contains a base directory with the specified name. <p> When
   * extracting such archive, a directory with the specified {@code name} will be created with the
   * content of the project instead of extracting it in the directory itself.
   *

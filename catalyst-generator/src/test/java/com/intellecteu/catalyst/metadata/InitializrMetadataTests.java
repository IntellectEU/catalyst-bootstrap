...
public class InitializrMetadataTests {
  ...
  public void invalidBomVersionRangeMappingUnknownRepo() {
    ...
    BillOfMaterials.Mapping mapping = BillOfMaterials.Mapping.create("1.3.0.M2", "1.2.0");
  ...
  public void updateSpringBootVersions() {
    ...
    bom.getMappings()
        .add(BillOfMaterials.Mapping.create("1.3.x.BUILD-SNAPSHOT", "1.1.0-BUILD-SNAPSHOT"));
  ...
  private InitializrConfiguration.Env.Kotlin.Mapping createKotlinVersionMapping(String versionRange,

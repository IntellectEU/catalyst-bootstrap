...
public class AbstractProjectRequestPostProcessor implements ProjectRequestPostProcessor {
  ...
  /**
   * Determine if the {@link ProjectRequest request} defines the dependency with the specified
   * {@code dependencyId}.
   *
  ...
  /**
   * Determine if the {@link ProjectRequest request} defines the dependencies with the specified
   * {@code dependenciesId}.
   *
   * @param request the request to handle
  ...
  /**
   * Return the {@link Dependency} with the specified {@code id} or {@code null} if the project does
   * not define it.
   *
   * @param request the request to handle
   * @param id the id of a dependency
   * @return the {@link Dependency} with that id or {@code null} if the project does not define such
   * dependency
   */
  ...
  /**
   * Specify if the Spring Boot version of the {@link ProjectRequest request} is higher or equal to
   * the specified {@link Version}.
   *
   * @param request the request to handle
   * @param version the minimum version
   * @return {@code true} if the requested version is equal or higher than the specified {@code
   * version}
   */

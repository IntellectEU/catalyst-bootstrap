...
/**
 * Determine the appropriate Spring Cloud stream dependency to use based on the selected messaging
 * technology. <p> Does not replace the messaging technology jar by the relevant binder. If more
 * than one tech is selected, it is far more easier to remove the unnecessary binder jar than to

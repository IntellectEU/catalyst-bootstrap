...
public enum InitializrMetadataVersion {
  ...
  /**
   * Add "versionRange" attribute to any dependency to specify which Spring Boot versions are
   * compatible with it. Also provide a separate "dependencies" endpoint to query dependencies
   * metadata.
   */

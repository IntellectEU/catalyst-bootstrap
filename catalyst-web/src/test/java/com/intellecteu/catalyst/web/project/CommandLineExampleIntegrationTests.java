...
/**
 * Validate that the "raw" HTTP commands that are described in the command-line help works. If
 * anything needs to be updated here, please double check the "curl-examples.txt" as it may need an
 * update as well. This is also a good indicator of a non backward compatible change.
 *
